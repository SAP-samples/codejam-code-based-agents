...
const insert = db.prepare(`
  INSERT OR REPLACE INTO artworks
    (ITEM_ID, ITEM_NAME, ARTIST, ACQUISITION_DATE, INSURANCE_VALUE, ITEM_CATEGORY,
     DIMENSIONS, CONDITION_SCORE, RARITY_SCORE, PROVENANCE_CLARITY)
  VALUES
    (@ITEM_ID, @ITEM_NAME, @ARTIST, @ACQUISITION_DATE, @INSURANCE_VALUE, @ITEM_CATEGORY,
     @DIMENSIONS, @CONDITION_SCORE, @RARITY_SCORE, @PROVENANCE_CLARITY)
`);

// NULL = value unknown, will become '[PREDICT]' when building the RPT-1 payload
const artworks = [
  ...
  { ITEM_ID: "ART_003", ITEM_NAME: "Irises", ARTIST: "Vincent van Gogh", ACQUISITION_DATE: "2001-11-08", INSURANCE_VALUE: null, ITEM_CATEGORY: "Painting", DIMENSIONS: "71x93cm", CONDITION_SCORE: 7, RARITY_SCORE: 9, PROVENANCE_CLARITY: 8 },
  ...
  { ITEM_ID: "ART_007", ITEM_NAME: "Girl with a Pearl Earring", ARTIST: "Johannes Vermeer", ACQUISITION_DATE: "2003-07-11", INSURANCE_VALUE: null, ITEM_CATEGORY: "Painting", DIMENSIONS: "44x39cm", CONDITION_SCORE: 8, RARITY_SCORE: 10, PROVENANCE_CLARITY: 9 },
  ...
  { ITEM_ID: "ART_009", ITEM_NAME: "The Persistence of Memory", ARTIST: "Salvador Dalí", ACQUISITION_DATE: "2005-03-10", INSURANCE_VALUE: 35000000, ITEM_CATEGORY: null, DIMENSIONS: "24x33cm", CONDITION_SCORE: 9, RARITY_SCORE: 9, PROVENANCE_CLARITY: 10 },
  ...
  { ITEM_ID: "ART_012", ITEM_NAME: "The Thinker", ARTIST: "Auguste Rodin", ACQUISITION_DATE: "2000-11-05", INSURANCE_VALUE: null, ITEM_CATEGORY: "Sculpture", DIMENSIONS: "Height: 1.9m", CONDITION_SCORE: 9, RARITY_SCORE: 7, PROVENANCE_CLARITY: 9 },
...
const insertMany = db.transaction((items: typeof artworks) => {
...
console.log(`✅ artworks.db seeded with ${artworks.length} artworks at ${DB_PATH}`);
db.close();
